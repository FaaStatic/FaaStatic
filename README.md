...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=260&color=0:0A0005,30:1C0035,70:FFE81A,100:0D0D0D&text=SUHAILI%20FARUQ&fontSize=55&fontColor=FFE81A&animation=fadeIn&fontAlignY=38&desc=Mobile%20Engineer%20•%20React%20Native%20•%20Flutter%20•%20Kotlin%20•%20Go%20Backend&descAlignY=58&descSize=18&descColor=FF003C"/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&weight=700&size=26&pause=1000&color=FFE81A&center=true&vCenter=true&width=1000&height=100&lines=React+Native+%2F%2F+Primary+Stack.;Flutter+%2F%2F+7+Apps+Shipped+to+Store.;Offline-First+%2F%2F+Realm+%7C+Room+%7C+SQLite.;Go+Fiber+%2F%2F+Backend+Services.)](https://git.io/typing-svg)
...
class Developer {
  ...
  final String focus =
      "Offline-first mobile apps with reliable background sync, "
...
Currently building COIP Mobile at **PT United Tractors Tbk**, an offline-first field
inspection app for heavy equipment customers. Before that, four years of shipping
production apps for mall loyalty programs, city government tax services, network
operations tooling, and batik e-commerce.

---

# SHIPPED.APPS

Seven apps published to the Play Store and App Store. All verifiable, none of them demos.
...
<div align="center">
<img src="https://skillicons.dev/icons?i=react,ts,flutter,dart,kotlin,androidstudio"/>
<br/><br/>
<img src="https://img.shields.io/badge/React_Native-Primary_Stack-61DAFB?style=for-the-badge&logo=react&logoColor=black"/>
...
**Offline-first is the thing I actually specialise in.** Realm, Room, and SQLite with queued
sync that survives a bad connection in the field. On COIP Mobile that means job creation,
multi-tab checksheets with conditional validation across 100+ fields, and photo evidence
that uploads when the technician gets signal back.

The typed API layer is generated from the backend OpenAPI spec with Kubb, so there is no
hand-written client code and no schema drift. Around 100 unit and UI tests (Jest, RNTL)
keep it honest.
...
| [**KMP Todo**](https://github.com/FaaStatic/kmp_todo_app) | Full-stack Kotlin. Compose Multiplatform client (Android + iOS) sharing domain models with a Ktor backend. JWT with refresh tokens, BCrypt, Swagger. | Kotlin Multiplatform, Ktor, Exposed, PostgreSQL |
...
Backend is where I spend my side-project time. The POS service is the one I run in production
for myself, which is how I ended up learning Certbot, Nginx, and Docker Compose the hard way.
